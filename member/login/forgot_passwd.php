...
<html lang="ko" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/santteut/member/login/css/forgot_passwd.css">
  ...
  <body>
    ...
    <div class="login_form">
      ...
      <table>
        ...
        <tr>
          <th style="height:1%;">아이디</th>
          <td>
            <input type="text" name="" value="" size="29">
          </td>
        <tr>
