(function(document) {
	...
	var Loader = {
		...
		ready: function(fn) {
			...
			// iframe.tx_canvas_wysiwyg.document.body.innerHTML= iframe.tx_canvas_wysiwyg.document.body.innerHTML+''+"되라아아아아아";
			// alert();
//test
			// tx_canvas_source_holder
		...
		finish: function() {
			...
			onLoadHandlers = [];
			// iframe.tx_canvas_wysiwyg.document.body.innerHTML= iframe.tx_canvas_wysiwyg.document.body.innerHTML+''+"되라아아아아아";
			document.getElementById('tx_canvas_source_holder').innerHTML= 'dfefef';

			// document.getElementById('tx_canvas_source_holder').innerHTML('dfefef');
			// iframe.tx_canvas_wysiwyg.document.getElementById('tx_canvas_text').innerHTML = "defef";
		},
