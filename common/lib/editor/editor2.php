...
<html lang="ko" dir="ltr">
  ...
  <body>
    ...
    $manage_view_sql = "SELECT * FROM `package` where `p_code`='$code';";
    $manage_result=mysqli_query($conn, $manage_view_sql);
    ...
    <div class="body">
        ...
        <table id="insert_form">
          <tr>
            <td><p>패키지 코드</p></td>
            <td> <input type="text" name="p_code" value="<?=$p_code?>" readonly> <p style="display:inline">종류</p>
          ...
          <tr>
            <td><p>패키지 이름</p></td>
            <td> <input type="text" name="p_name" value="<?=$p_name?>" size="50"> </td>
          ...
          <tr>
            <td><p>출발일</p></td>
            <td> <input type="date" name="p_dp_date" value="<?=$p_dp_date?>" > </td>
          </tr>

          <tr>
            <td><p>출발 시간</p></td>
            <td> <input type="time" name="p_dp_time" value="<?=$p_dp_time?>"> </td>
          </tr>

          <tr>
            <td><p>도착 시간</p></td>
            <td> <input type="time" name="p_arr_time" value="<?=$p_arr_time?>"> </td>
          </tr>

          <tr>
            <td><p>패키지 요금</p></td>
            <td> <input type="text" name="p_pay" value="<?=$p_pay?>"><b>원</b> </td>
          </tr>
          ...
          <tr>
            <td><p>출발지</p></td>
            <td> <input id="p_dp_city" type="text" name="p_dp_city" value="<?=$p_dp_city?>" onclick="select_area()"> </td>
          </tr>

          <tr>
            <td><p>도착지</p></td>
            <td> <input id="p_arr_mt" type="text" name="p_arr_mt" value="<?=$p_arr_mt?>" onclick="select_area()"> </td>
          </tr>
