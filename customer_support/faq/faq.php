  ...
  <body>
    ...
    <div id="faq_main" style="height: 1050px; max-height:2000px;">
     ...
     <table id="table1">
       ...
       <!-- slidetoggle 액션  -->
       <tr><td id="li1">Q.&nbsp;등산 시 속도를 못 쫓아갈까바 걱정이 됩니다. 괜찮을까요?</td></tr>
       <tr id="li1_1" style="display:none;"><td>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;최종 목적지에 도착할 때까지 다른 일행들 보다 너무 뒤쳐지지 않게 신경써서 이동 해 주시고, 등산 스틱을 사용 하시면 보행 시간 단축에 도움을 받으실 수 있습니다.</small></td></tr>
       <tr><td id="li2">Q.&nbsp;패키지마다 인솔자가 계시나요?</td></tr>
       <tr id="li2_1" style="display:none;"><td >
        &nbsp;<small><b>A. </b>산악회 직원이 인솔자로 동행하게 됩니다.</small></td></tr>
       <tr><td id="li3">Q.&nbsp;등산 중 화장실은 어떻게 사용 하나요?</td></tr>
       <tr id="li3_1" style="display:none;"><td >
        &nbsp;<small><b>A. </b>지역에 따라 상이 하나 보통 산장 또는 간이 화장실을 사용하며, 1회용 휴대 화장실을 사용해야 하는 경우도 있습니다.</small></td></tr>
       <tr><td id="li4">Q.&nbsp;신용 불량자도 해외여행을 할 수 있나요?</td></tr>
       ...
       <tr><td id="li5">Q.&nbsp;회원탈퇴는 어떻게 하나요?</td></tr>
       <tr id="li5_1" style="display:none;"><td >
        &nbsp;<small><b>A. </b>상단의 오른쪽메뉴에서 MY > 정보수정에서 탈퇴를 하실수 있습니다.</small></td></tr>
       <tr><td id="li6">Q.&nbsp;여행 경비는 얼마정도 가져가야 할까요?</td></tr>
       <tr id="li6_1" style="display:none;"><td >
        &nbsp;<small><b>A. </b>상품정보에 포함 되어 있지 않은 사항을 확인 하시고 여행 일수 별로 개인 경비를 준비하시면 됩니다.<br>
          &nbsp;&nbsp;&nbsp;&nbsp;자유시간이 없는 경우 선택관광이나 쇼핑은 할 수 없습니다.</small></td></tr>
       <tr><td id="li7">Q.&nbsp;비회원도 사이트 이용이 가능한가요?</td></tr>
       <tr id="li7_1" style="display:none;"><td >
        &nbsp;<small><b>A. </b>자유게시판과 공지사항만 보기가 가능하며 그 외 기능은 회원가입후 이용가능하십니다.  </small></td></tr>
       <tr><td id="li8">Q.&nbsp;숙식이랑 항공권은 개인부담인가요?</td></tr>
       <tr id="li8_1" style="display:none;"><td >
        &nbsp;<small><b>A. </b>모든 패키지가 숙식과 항공권이 포함되어있는 금액입니다.</small></td></tr>
