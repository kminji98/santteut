...
<html lang="ko" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/santteut/community/mt_information/css/mt_information_view.css">
  ...
  <body>
    ...
    <section id="notice">
      ...
      <div id="view_button">
        ...
        echo ('<a href="./mt_information_form.php?mode=update&num='.$num.'"><input type="button" value="수정">&nbsp;</a>&nbsp;');
        echo ('<input type="button" value="삭제" onclick="check_delete('.$num.')">&nbsp;</a>&nbsp;');
        echo ('<a href="./mt_information_list.php?page='.$page.'"><input type="button" value="목록">&nbsp;</a>');
      }else{
        echo ('<div class="mt_list" style="margin-left: 25.5%;">
          <a href="./mt_information_list.php?page='.$page.'"><input type="button" value="목록">&nbsp;</a>
          </div>');
      }
        ?>
