...
<body>
	<div id=wrap>
		...
		<div align=center>
			<input type="text" name="email1" size="10" style="height: 30px;"> @
			<input type="text" name="email2" size="10" style="width:120px; height: 30px;">
			<a href="#"><img src="../image/email_conf_receive.jpg" onclick="check_email_conf()" style="height: 30px;"></a>
		</div>
		</form>
		<br>
